...
import com.ls.librarysystem.filter.URLPathMatchingFilter;
import com.ls.librarysystem.realm.MyRealm;
...
//        filterChainDefinitionMap.put("/api/authentication", "authc"); // 防鸡贼登录，暂时不需要
    ...
    public CookieRememberMeManager rememberMeManager() {
        ...
        cookieRememberMeManager.setCipherKey("LIBRARY".getBytes());
